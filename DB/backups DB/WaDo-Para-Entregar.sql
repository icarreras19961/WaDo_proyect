...
--
-- Servidor: localhost
-- Tiempo de generación: 03-05-2024 a las 13:55:49
...
INSERT INTO `034_actividad` (`id`, `nombre`, `ubicacion`, `puntuacion`, `tags_json`) VALUES
...
CREATE TABLE `034_comercio` (
  `id` int(11) NOT NULL,
  `comercio_nombre` varchar(255) NOT NULL,
  `comercio_ubicacion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `tags_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`tags_json`)),
...
INSERT INTO `034_comercio` (`id`, `comercio_nombre`, `comercio_ubicacion`, `tags_json`, `telefono`, `email`) VALUES
...
INSERT INTO `034_servicio` (`id`, `nombre`, `ubicacion`, `puntuacion`, `tags_json`, `id_comercio`) VALUES
...
INSERT INTO `034_tags` (`id`, `nombre`) VALUES
(1, 'exterior'),
(2, 'interior'),
(3, 'sendero'),
(4, 'acuatico'),
...
INSERT INTO `034_usuario` (`id`, `nombre`, `apellido`, `password`, `email`) VALUES
...
--
ALTER TABLE `034_tags`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `usuario`
--
ALTER TABLE `034_usuario`
  ADD PRIMARY KEY (`id`);
